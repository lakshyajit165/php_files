...
<html lang="en">
  ...
  <body>
    <div class="container" style="text-align:center;">
       <h1>Retrieve Data From a Database!</h1><hr><br>
	   <h3>Enter the name whose details need to be displayed:</h3>
           ...
           if (isset($_POST['find'])){
            if( mysqli_num_rows($result) > 0 ) {
                ...
                // output the data
                      ...
                      echo "<h3>ID:</h3>". $row["id"] ."<br>"."<h3>Name:</h3>". $row["username"] ."<br>"."<h3>Email:</h3>". $row["email"] ;
